...
export class PostService {
  ...
  getProducts(): Promise<any> {
    return lastValueFrom(
      this.http.get(`${environment.apiUrl}/product?page=1&chunk=1000`)
    );
  }

  getPopular(): Promise<any> {
    return lastValueFrom(
      this.http.get(`${environment.apiUrl}/popular?page=1&chunk=1000`)
    );
  }
  ...
  createProducts(product: any) {
    ...
    return lastValueFrom(
      this.http.post(`${environment.apiUrl}/product`, formData, options)
    );
  }
  ...
  deleteProduct(product: any): Promise<any> {
    ...
    return lastValueFrom(
      this.http.delete(`${environment.apiUrl}/product/${product.id}`, options)
    );
  }
  ...
  createCategory(name: any, image: any): Promise<any> {
    ...
    return lastValueFrom(
      this.http.post(`${environment.apiUrl}/category`, formData, options)
    );
  }
  ...
  sendFeedback(mail: any, details: any) {
    ...
    return lastValueFrom(
      this.http.post(`${environment.apiUrl}/contactus`, formData)
    );
  }
  ...
  postSearchService(search: any) {
    ...
    return lastValueFrom(
      this.http.post(`${environment.apiUrl}/search`, formData)
    );
  }
  ...
  forgetPassword(email: any) {
    ...
    return lastValueFrom(
      this.http.post(`${environment.apiUrl}/auth/forgot_password`, formData)
    );
  }
