...
import { getPurchaseServices, createPurchaseServices, findPurchaseServices, updatePurchaseServices, deletePurchaseServices, getPurchaseByUserIdServices } from "../services/purchaseService";
...
export const getPurchaseByUserId = async (req: any, res: Response) => {
  getPurchaseByUserIdServices(req, res);
};